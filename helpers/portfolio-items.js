export const projects = [
  ...
  },
  {
    ...
    description: 'Il portale è stato realizzando attraverso il framework Laravel per la parte back-end facendo ampio uso di redis per velocizzare il recupero dei dati. Per la parte front-end invece è stato utilizzato vue, nuxt e vuetify. Sono state anche realizzate una serie di API rivolte allo scambio di informazioni con il sito web principale e l\'app mobile.'
  },
  {
    slug: 'portale-cacciatori',
    title: 'Portale Fauna Associaz. Cacciatori',
    ...
    link: '/progetti/portale-cacciatori',
  ...
  {
    slug: 'portale-cani-da-traccia',
    title: 'Cani da traccia Associaz. Cacciatori',
    ...
    link: '/progetti/portale-cani-da-traccia',
    ...
    description: 'Il portale è basato sul framework Laravel il quale gestisce tutta la parte back-end del progetto e l’interazione dinamica con l’UI. La parte front-end è stata realizzata utilizzando il framework vue.js basato su Javascript il quale permette di realizzare e gestire tutta l’interfaccia grafica adattandosi ad ogni dispositivo.'
  },
  {
    slug: 'app-cacciatori',
    title: 'App Associaz. Cacciatori',
  ...
  },
  {
    ...
    year: 2019,
    url: '#',
    link: '/progetti/tensorflow-captcha',
  ...
  },
  {
    ...
    year: 2019,
    url: '#',
    link: '/progetti/scarping-web-file-excel',
  ...
  },
  {
    ...
    link: '/progetti/portale-cinghiali',
    caseStudy: 'Con la necessità di digitalizzare i processi cartacei è stato realizzato il portale per la gestione degli interventi di gestione dei cinghiali sul territorio della provincia di Trento.',
    description: 'Il portale è basato sul framework Laravel il quale gestisce la parte di back-end del progetto mentre il framework vue.js in combinazione con vuetify per gestire la parte front-end. Il portale ha lo scopo di gestire le varie tipologie di denunce da parte degli utenti connesse al ruolo dell\'utente con regole e protocolli differenti.'
  },
  {
    slug: 'programma-ricerca',
    ...
    year: 2018,
    url: '#',
    link: '/progetti/programma-ricerca',
    ...
    description: 'Il programma per piattaforme windows è altamente personalizzabile in base alle richieste del cliente, il quale oltre a molte modalità di funzionamento prevede la configurazione dei campi di ricerca basandosi su dei profili caricabili dinamicamente dal programma tramite dei file json.'
  },
  {
    slug: 'programma-ricerca-web-based',
    ...
    year: 2019,
    url: '#',
    link: '/progetti/programma-ricerca-web-based',
    ...
    description: 'La web app è stata realizzata utilizzando il framework Laravel e vuejs per ricreare le medesime funzionalità di ricerca dei pdf basandosi su un sistema centralizzato su un server interno aziendale, oltre a permettere la ricerca è possibile anche gestire direttamente tutti i dati da parte degli amministratori permettendo anche upload massivi dei dati basandosi su un file csv.'
  },
  {
    slug: 'app-gnpmaps',
    title: 'App GNP Maps',
    ...
    link: '/progetti/app-gnpmaps',
    caseStudy: 'Il cliente inizialmente voleva un\'app per smartphone la quale permettesse ai clienti di consultare i propri punti vendita potendo anche ricercabili in base a caratteristiche. Successivamente a uno studio di fattibilità è stata aggiunta anche la possibilità di gestire anche le proprie tessere carburante.',
